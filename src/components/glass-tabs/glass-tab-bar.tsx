 ...
 *
 * Vendored from expo-glass-tabs: the upstream bar layers a dark tint over
 * the glass and stacks a progressive blur + black gradient behind the pill;
 * both are removed here so the glass stays untinted and content scrolls
 * cleanly underneath.
 */
